...
* **シミュレーションモード (Simulation Mode) [推奨]**
  ...
  > 
  > この3つの要素を1秒間に何十回も計算・調整することで、まるで熟練のドライバーがメーターを見ながらアクセルペダルをミリ単位で微調整しているかのように、滑らかで自然なペダリング追従を実現しています。
...
* **対応ゲーム**: UDPデータアウトプット（テレメトリ送信）機能を備えたレースゲーム（例：Forza Horizon 4 / 5、Forza Motorsportシリーズなど）
